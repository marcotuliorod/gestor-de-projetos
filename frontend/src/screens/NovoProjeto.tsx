...
import { api, type AvailableRepo, type DetectedStack, type ModelChoice } from '../lib/api'
...
export function NovoProjeto() {
  ...
  return (
    <div className="novo">
      <h1>Novo projeto</h1>
      <p className="novo-sub">
        Conecte um repositório do GitHub. Eu leio a stack e sugiro os comandos de build, teste e lint.
      </p>
